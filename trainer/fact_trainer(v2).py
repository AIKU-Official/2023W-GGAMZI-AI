...
class FactTrainer(BaseTrainer):
        ...
        for batch in tqdm(cyclize(loader)):
            ...
            if self.cfg.gpu <= 0:
                ...
                if self.step % self.cfg.tb_freq == 0: 
                    self.plot(epoch, losses, discs, stats) # 23.11.29 수정 'epoch' 파라미터 추가
    ...
    def plot(self, epoch, losses, discs, stats):
        ...
        plt.savefig(f'/content/drive/MyDrive/2023학교/AIKU/2023_2_project2/mxfont-main/train_results/figs/g_total_epoch{epoch}.png')
        ...
        plt.savefig(f'/content/drive/MyDrive/2023학교/AIKU/2023_2_project2/mxfont-main/train_results/figs/pixel_epoch{epoch}.png')
