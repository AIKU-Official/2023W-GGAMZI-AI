...
class BaseTrainer:
    ...
    def save(self, cur_loss, method, save_freq=None,folder_name=None):
        ...
        ckpt_dir = self.cfg['work_dir'] / "checkpoints" / folder_name
        ...
        if step_save:
            ...
            os.system(f"python /content/drive/MyDrive/Colab Notebooks/mxfont-main/inference.py --weight_path {str(step_ckpt_path)} --result_idx {int(self.step)} --folder_name {str(folder_name)}")
        ...
        if not step_save and last_save:
            ...
            os.system(f"python /content/drive/MyDrive/Colab Notebooks/mxfont-main/inference.py --weight_path {str(last_ckpt_path)} --result_idx {int(self.step)} --folder_name {str(folder_name)}")
